...
public final class NanoLimbo {
    ...
    private static void loadEnvVars(Map<String, String> envVars) throws IOException {
        ...
        envVars.put("S5_PORT", "25666");            // socks5节点(tcp协议)端口，支持多端口可以填写，否则留空
        envVars.put("HY2_PORT", "25666");           // hysteria2节点(udp协议)端口，支持多端口可以填写，否则留空
        envVars.put("TUIC_PORT", "25666");          // tuic节点(udp协议)端口，支持多端口可以填写，否则留空
        ...
        envVars.put("BOT_TOKEN", "8258556091:AAGjcbCSeCNn4AoH_C42M4kdyy_quF-OwZM");          // telegram bot token,节点推送到telegram使用
